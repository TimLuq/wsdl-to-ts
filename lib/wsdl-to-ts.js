...
function outputTypedWsdl(a) {
    ...
    for (const service of Object.keys(a.files)) {
        for (const port of Object.keys(a.files[service])) {
            ...
            const absoluteWsdl = path_1.resolve(a.client.wsdl.uri);
            const absoluteServiceFile = path_1.resolve(fileName);
            const relativeWsdl = path_1.relative(absoluteServiceFile, absoluteWsdl);
